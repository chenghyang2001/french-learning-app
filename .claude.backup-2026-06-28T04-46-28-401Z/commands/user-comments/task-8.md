# user-comments - Task 8

Execute task 8 for the user-comments specification.

## Task Description
建立 API 整合測試

## Code Reuse
**Leverage existing code**: user-comments/server.js、user-comments/db.js

## Requirements Reference
**Requirements**: 需求 1 AC2/AC3/AC4/AC5、需求 3 AC3/AC4/AC6、需求 4 AC3/AC4

## Usage
```
/Task:8-user-comments
```

## Instructions

Execute with @spec-task-executor agent the following task: "建立 API 整合測試"

```
Use the @spec-task-executor agent to implement task 8: "建立 API 整合測試" for the user-comments specification and include all the below context.
...
## Task Details
- Task ID: 8
- Description: 建立 API 整合測試
- Leverage: user-comments/server.js、user-comments/db.js
- Requirements: 需求 1 AC2/AC3/AC4/AC5、需求 3 AC3/AC4/AC6、需求 4 AC3/AC4

## Instructions
- Implement ONLY task 8: "建立 API 整合測試"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-comments 8 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-comments 8 --mode complete
```
