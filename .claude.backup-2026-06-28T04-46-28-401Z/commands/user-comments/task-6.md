# user-comments - Task 6

Execute task 6 for the user-comments specification.

## Task Description
建立 `server.js`：輔助函式 + 靜態資源服務

## Code Reuse
**Leverage existing code**: countdown-timer/server.js（複用 readBody + sendJson 模式）

## Requirements Reference
**Requirements**: 技術約束（createRequestHandler 工廠模式供測試注入）

## Usage
```
/Task:6-user-comments
```

## Instructions

Execute with @spec-task-executor agent the following task: "建立 `server.js`：輔助函式 + 靜態資源服務"

```
Use the @spec-task-executor agent to implement task 6: "建立 `server.js`：輔助函式 + 靜態資源服務" for the user-comments specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: 建立 `server.js`：輔助函式 + 靜態資源服務
- Leverage: countdown-timer/server.js（複用 readBody + sendJson 模式）
- Requirements: 技術約束（createRequestHandler 工廠模式供測試注入）

## Instructions
- Implement ONLY task 6: "建立 `server.js`：輔助函式 + 靜態資源服務"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-comments 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-comments 6 --mode complete
```
