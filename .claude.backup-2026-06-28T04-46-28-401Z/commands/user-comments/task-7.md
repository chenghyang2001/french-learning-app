# user-comments - Task 7

Execute task 7 for the user-comments specification.

## Task Description
實作 API 路由至 `server.js`

## Code Reuse
**Leverage existing code**: user-comments/db.js、user-comments/server.js（Task 6 骨架）

## Requirements Reference
**Requirements**: 需求 1、需求 2、需求 3、需求 4 全部 AC

## Usage
```
/Task:7-user-comments
```

## Instructions

Execute with @spec-task-executor agent the following task: "實作 API 路由至 `server.js`"

```
Use the @spec-task-executor agent to implement task 7: "實作 API 路由至 `server.js`" for the user-comments specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: 實作 API 路由至 `server.js`
- Leverage: user-comments/db.js、user-comments/server.js（Task 6 骨架）
- Requirements: 需求 1、需求 2、需求 3、需求 4 全部 AC

## Instructions
- Implement ONLY task 7: "實作 API 路由至 `server.js`"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-comments 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-comments 7 --mode complete
```
