# user-comments - Task 4

Execute task 4 for the user-comments specification.

## Task Description
實作 DB 寫入函式（含完整驗證）

## Code Reuse
**Leverage existing code**: user-comments/db.js（Task 3 的讀取函式）

## Requirements Reference
**Requirements**: 需求 1 AC2/AC3（空白/超字數）、需求 3 AC3/AC4/AC6/AC7、需求 4 AC1/AC2

## Usage
```
/Task:4-user-comments
```

## Instructions

Execute with @spec-task-executor agent the following task: "實作 DB 寫入函式（含完整驗證）"

```
Use the @spec-task-executor agent to implement task 4: "實作 DB 寫入函式（含完整驗證）" for the user-comments specification and include all the below context.
...
## Task Details
- Task ID: 4
- Description: 實作 DB 寫入函式（含完整驗證）
- Leverage: user-comments/db.js（Task 3 的讀取函式）
- Requirements: 需求 1 AC2/AC3（空白/超字數）、需求 3 AC3/AC4/AC6/AC7、需求 4 AC1/AC2

## Instructions
- Implement ONLY task 4: "實作 DB 寫入函式（含完整驗證）"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks user-comments 4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks user-comments 4 --mode complete
```
